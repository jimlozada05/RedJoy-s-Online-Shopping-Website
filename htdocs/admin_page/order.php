          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">Customer Only</li>
            ...
            <!-------------Modal-------------->
            <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="edit_customer">
...
<script type="text/javascript">
    $(document).on("click", ".btn-delete-customer", function() {
        Swal.fire({
          title: 'Remove Customer Order?',
          text: "This customer's order will be remove",
          icon: 'warning',
        ...
        }).then((result) => 
        {
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "../DataBase/delete_customer.php",
                    data: {
                        "id": $(this).data("id")
                    },
                    success:function(data){
                        Swal.fire({
                        title: 'Removed!',
                        text: "Customer's order has been removed.",
                        icon: 'success',
                        }).then(function(){
...
<script type="text/javascript">
    $(document).on("click", ".btn-edit-customer", function() {
        $.ajax({
            type: "GET",
            url: "../templates/edit_customer_form.php",
            data: {
                "id": $(this).data("id")
            }
        }).then(function(data) {
            $("#edit_customer > .modal-dialog > .modal-content").html(data);
        });
    });
</script>
